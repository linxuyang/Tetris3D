...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] bool m_CustomShadowsProject = false;
        [SerializeField] float m_CustomShadowDistance = 10;
        [SerializeField] float m_ProjectSizeRate = 1;
        ...
        public static readonly string packagePath = "Assets/SRP/Universal";
        ...
        Material GetMaterial(DefaultMaterialType materialType)
        {
            ...
            switch (materialType)
            {
                case DefaultMaterialType.Standard:
                    return editorResources.materials.simpleColor;
        ...
        public bool customShadowProject
        {
            get { return m_CustomShadowsProject; }
        }

        public float customShadowDistance
        {
            get { return m_CustomShadowDistance; }
            set { m_CustomShadowDistance = Mathf.Max(0.0f, value); }
        }

        public float projectSizeRate
        {
            get { return m_ProjectSizeRate; }
            set { m_ProjectSizeRate = Mathf.Clamp01(value); }
        }
