...
namespace UnityEngine.Rendering.Universal
{
    ...
    public struct CameraData
    {
        ...
        public CameraRenderType renderType; //base或overlay
        public RenderTexture targetTexture; //来自camera.targetTexture
        public RenderTextureDescriptor cameraTargetDescriptor; //有camera.targetTexture则复制属性，没有则创建
        internal Rect pixelRect; //来自camera.pixelRect
        internal int pixelWidth;    //来自camera.pixelWidth
        internal int pixelHeight;   //来自camera.pixelHeight
        internal float aspectRatio; //pixelWidth/pixelHeight
        public float renderScale;   //setting.renderScale
        internal ImageScalingMode imageScalingMode; //图形缩放模式，取决于renderScale
        internal ImageUpscalingFilter upscalingFilter;
        internal bool fsrOverrideSharpness;
        internal float fsrSharpness;
        public bool clearDepth; //是否清除深度
        public CameraType cameraType;   //场景相机或游戏相机
        public bool isDefaultViewport;
        public bool isHdrEnabled;
        public bool requiresDepthTexture;   //settings.supportsCameraDepthTexture
        public bool requiresOpaqueTexture;  //settings.supportsCameraOpaqueTexture

        public bool postProcessingRequiresDepthTexture; //后处理是否需要深度图
    ...
    {
        public static readonly string MainLightShadows = "_MAIN_LIGHT_SHADOWS"; //级联为1
        public static readonly string MainLightShadowCascades = "_MAIN_LIGHT_SHADOWS_CASCADE"; //级联大于1
        public static readonly string MainLightShadowScreen = "_MAIN_LIGHT_SHADOWS_SCREEN"; //屏幕空间阴影
        ...
        public static readonly string AdditionalLightsVertex = "_ADDITIONAL_LIGHTS_VERTEX"; //额外灯光顶点照明
        public static readonly string AdditionalLightsPixel = "_ADDITIONAL_LIGHTS"; //额外灯光像素照明
        internal static readonly string ClusteredRendering = "_CLUSTERED_RENDERING";
        public static readonly string AdditionalLightShadows = "_ADDITIONAL_LIGHT_SHADOWS"; //额外灯光阴影
        public static readonly string ReflectionProbeBoxProjection = "_REFLECTION_PROBE_BOX_PROJECTION"; //setting设置的ProbeBlending
        public static readonly string ReflectionProbeBlending = "_REFLECTION_PROBE_BLENDING";   //setting设置的BoxProjection
        public static readonly string SoftShadows = "_SHADOWS_SOFT";    //软阴影
        public static readonly string MixedLightingSubtractive = "_MIXED_LIGHTING_SUBTRACTIVE"; // Backward compatibility 
        public static readonly string LightmapShadowMixing = "LIGHTMAP_SHADOW_MIXING"; //subtractive或shadowMask
        public static readonly string ShadowsShadowMask = "SHADOWS_SHADOWMASK"; //shadowMask
