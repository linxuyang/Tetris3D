...
#include "Assets/SRP/Core/ShaderLibrary/Shadow/ShadowSamplingTent.hlsl"
#include "Core.hlsl"
...
float4      _CustomShadowCenter; // xyz: 自定义阴影有效范围中心点 w: 1-使用自定义中心点 0-不使用
#ifndef SHADER_API_GLES3
CBUFFER_END
#endif
...
{
    float3 center = lerp(_WorldSpaceCameraPos, _CustomShadowCenter.xyz, _CustomShadowCenter.w);
    float3 camToPixel = positionWS - center;
    float distanceCamToPixel2 = dot(camToPixel, camToPixel);
