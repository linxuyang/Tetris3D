...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal partial class UniversalRenderPipelineAssetUI
    {
        ...
        static void DrawShadows(SerializedUniversalRenderPipelineAsset serialized, Editor ownerEditor)
        {
            ...
            EditorGUILayout.PropertyField(serialized.customShadowsProjectProp, Styles.customShadowsProject);
            if (serialized.customShadowsProjectProp.boolValue)
            {
                EditorGUILayout.PropertyField(serialized.customShadowDistanceProp, Styles.customShadowDistance);
                EditorGUILayout.Slider(serialized.projectSizeRateProp, 0, 1, Styles.projectSizeRate);
            }
            EditorGUI.indentLevel--;
        }
