...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        public static class Styles
        {
            ...
            public static GUIContent customShadowsProject = EditorGUIUtility.TrTextContent("自定义投影矩阵", "开启该选项可以将阴影的投影中心点改为玩家角色所在位置(用于改善角色阴影质量)");
            public static GUIContent customShadowDistance = EditorGUIUtility.TrTextContent("自定义阴影范围", "以角色所在位置为中心的阴影范围的半径");
            public static GUIContent projectSizeRate = EditorGUIUtility.TrTextContent("阴影裁剪矩阵比例", "该值可以调整渲染阴影的裁剪矩阵大小, 约小则阴影质量越高, 但也更容易穿帮");
