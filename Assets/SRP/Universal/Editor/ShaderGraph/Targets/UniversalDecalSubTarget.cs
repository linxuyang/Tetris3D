    ...
    sealed class UniversalDecalSubTarget : SubTarget<UniversalTarget>
    {
        ...
        static class DecalPasses
        {
            public static PassDescriptor ScenePicking = new PassDescriptor()
            {
                ...
                // Template
                passTemplatePath = "Assets/SRP/Universal/Editor/Decal/DecalPass.template",
        ...
        {
            const string kDecalInput = "Assets/SRP/Universal/ShaderLibrary/DecalInput.hlsl";
            const string kShaderVariablesDecal = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/ShaderVariablesDecal.hlsl";
            const string kPassDecal = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/ShaderPassDecal.hlsl";
            ...
            const string kGBuffer = "Assets/SRP/Universal/ShaderLibrary/UnityGBuffer.hlsl";
