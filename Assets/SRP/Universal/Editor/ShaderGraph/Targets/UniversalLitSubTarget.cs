...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
    sealed class UniversalLitSubTarget : UniversalSubTarget, ILegacyTarget
    {
        ...
        {
            const string kShadows = "Assets/SRP/Universal/ShaderLibrary/Shadows.hlsl";
            const string kMetaInput = "Assets/SRP/Universal/ShaderLibrary/MetaInput.hlsl";
            const string kForwardPass = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/PBRForwardPass.hlsl";
            const string kGBuffer = "Assets/SRP/Universal/ShaderLibrary/UnityGBuffer.hlsl";
            const string kPBRGBufferPass = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/PBRGBufferPass.hlsl";
            const string kLightingMetaPass = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/LightingMetaPass.hlsl";
            const string k2DPass = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/PBR2DPass.hlsl";
