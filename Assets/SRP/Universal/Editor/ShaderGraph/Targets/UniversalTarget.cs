...
namespace UnityEditor.Rendering.Universal.ShaderGraph
{
...
#endif
    {
        ...
        {
            "Assets/SRP/Universal/Editor/ShaderGraph/Templates"
#if HAS_VFX_GRAPH
            , "Packages/com.unity.visualeffectgraph/Editor/ShaderGraph/Templates"
#endif
        }).ToArray();
        public const string kUberTemplatePath = "Assets/SRP/Universal/Editor/ShaderGraph/Templates/ShaderPass.template";
        ...
        internal override bool prefersSpritePreview => false;
    ...
    {
        const string kColor = "Assets/SRP/Core/ShaderLibrary/Color.hlsl";
        const string kTexture = "Assets/SRP/Core/ShaderLibrary/Texture.hlsl";
        const string kCore = "Assets/SRP/Universal/ShaderLibrary/Core.hlsl";
        const string kLighting = "Assets/SRP/Universal/ShaderLibrary/Lighting.hlsl";
        const string kGraphFunctions = "Assets/SRP/Universal/ShaderLibrary/ShaderGraphFunctions.hlsl";
        const string kVaryings = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/Varyings.hlsl";
        const string kShaderPass = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/ShaderPass.hlsl";
        const string kDepthOnlyPass = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/DepthOnlyPass.hlsl";
        const string kDepthNormalsOnlyPass = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/DepthNormalsOnlyPass.hlsl";
        const string kShadowCasterPass = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/ShadowCasterPass.hlsl";
        const string kTextureStack = "Assets/SRP/Core/ShaderLibrary/TextureStack.hlsl";
        const string kDBuffer = "Assets/SRP/Universal/ShaderLibrary/DBuffer.hlsl";
        const string kSelectionPickingPass = "Assets/SRP/Universal/Editor/ShaderGraph/Includes/SelectionPickingPass.hlsl";
