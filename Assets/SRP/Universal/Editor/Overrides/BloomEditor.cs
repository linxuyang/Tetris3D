...
namespace UnityEditor.Rendering.Universal
{
    ...
    sealed class BloomEditor : VolumeComponentEditor
    {
        ...
        SerializedDataParameter m_SampleTimes;
        SerializedDataParameter m_AntiFlicker;
        ...
        public override void OnEnable()
        {
            ...
            m_SampleTimes = Unpack(o.Find(x => x.sampleTimes));
            m_AntiFlicker = Unpack(o.Find(x => x.antiFlicker));
        ...
        public override void OnInspectorGUI()
        {
            ...
            PropertyField(m_SampleTimes);
            PropertyField(m_AntiFlicker);
