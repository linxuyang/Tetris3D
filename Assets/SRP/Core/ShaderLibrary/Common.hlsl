...
#include "Assets/SRP/Core/ShaderLibrary/API/D3D11.hlsl"
#elif defined(SHADER_API_METAL)
#include "Assets/SRP/Core/ShaderLibrary/API/Metal.hlsl"
#elif defined(SHADER_API_VULKAN)
#include "Assets/SRP/Core/ShaderLibrary/API/Vulkan.hlsl"
#elif defined(SHADER_API_SWITCH)
#include "Assets/SRP/Core/ShaderLibrary/API/Switch.hlsl"
#elif defined(SHADER_API_GLCORE)
#include "Assets/SRP/Core/ShaderLibrary/API/GLCore.hlsl"
#elif defined(SHADER_API_GLES3)
#include "Assets/SRP/Core/ShaderLibrary/API/GLES3.hlsl"
#elif defined(SHADER_API_GLES)
#include "Assets/SRP/Core/ShaderLibrary/API/GLES2.hlsl"
#else
#error unsupported shader api
#endif
#include "Assets/SRP/Core/ShaderLibrary/API/Validate.hlsl"

#include "Assets/SRP/Core/ShaderLibrary/Macros.hlsl"
#include "Assets/SRP/Core/ShaderLibrary/Random.hlsl"
...
#include "Assets/SRP/Core/ShaderLibrary/CommonDeprecated.hlsl"
...
half4 UpsampleBox(TEXTURE2D_PARAM(tex, samplerTex), float2 uv, float2 texelSize, float sampleScale)
{
