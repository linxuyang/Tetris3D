...
namespace UnityEditor.Rendering
{
    ...
    {
        private const string kPathToHorizontalGradientTexture = "Assets/SRP/Core/Editor/Lighting/Icons/HorizontalGradient.png";
        private const string kPathToUpSnatchTexture = "Assets/SRP/Core/Editor/Lighting/Icons/UpSnatch.png";
        private const string kPathToUpSnatchFocusedTexture = "Assets/SRP/Core/Editor/Lighting/Icons/UpSnatchFocused.png";
        private const string kPathToDownSnatchTexture = "Assets/SRP/Core/Editor/Lighting/Icons/DownSnatch.png";
        private const string kPathTDownSnatchFocusedTexture = "Assets/SRP/Core/Editor/Lighting/Icons/DownSnatchFocused.png";
