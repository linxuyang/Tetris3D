...
namespace UnityEditor.Rendering.LookDev
{
    ...
    partial class DisplayWindow : EditorWindow, IViewDisplayer
    {
        ...
        {
            internal const string k_IconFolder = @"Assets/SRP/Core/Editor/LookDev/Icons/";
            internal const string k_uss = @"Assets/SRP/Core/Editor/LookDev/DisplayWindow.uss";
            internal const string k_uss_personal_overload = @"Assets/SRP/Core/Editor/LookDev/DisplayWindow-PersonalSkin.uss";
