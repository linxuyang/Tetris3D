    ...
    sealed class PreviewTarget : Target
    {
        ...
        static class Passes
        {
            public static PassDescriptor Preview = new PassDescriptor()
            {
                ...
                {
                    // Pre-graph
                    { "Assets/SRP/Core/ShaderLibrary/Common.hlsl", IncludeLocation.Pregraph },
                    { "Assets/SRP/Core/ShaderLibrary/Packing.hlsl", IncludeLocation.Pregraph },
                    { "Assets/SRP/Core/ShaderLibrary/TextureStack.hlsl", IncludeLocation.Pregraph },       // TODO: put this on a conditional
                    { "Assets/SRP/Core/ShaderLibrary/NormalSurfaceGradient.hlsl", IncludeLocation.Pregraph },
                    { "Assets/SRP/Core/ShaderLibrary/Color.hlsl", IncludeLocation.Pregraph },
                    { "Assets/SRP/Core/ShaderLibrary/Texture.hlsl", IncludeLocation.Pregraph },
                    { "Assets/SRP/Core/ShaderLibrary/UnityInstancing.hlsl", IncludeLocation.Pregraph },
                    { "Assets/SRP/Core/ShaderLibrary/EntityLighting.hlsl", IncludeLocation.Pregraph },
